...
import 'package:gpspro/model/LatLngModel.dart';
  ...
  void getFences() async {
    ...
    _timer = Timer.periodic(Duration(seconds: 1), (timer) {
      if (args != null) {
        ...
        // 🔹 Caso círculo
        if (args!.fenceModel!.type == "circle") {
          if (args!.fenceModel!.center != null && args!.fenceModel!.radius != null) {
            setState(() {
              _myPainterToBitmap(args!.fenceModel!.name!, "marker")
                ...
                _markers.add(Marker(
                  ...
                  onTap: () {
                    ...
                    deleteFenceId = args?.fenceModel?.id?.toString();
                    deleteFenceVisible = deleteFenceId != null;
                  },
                ));
              });
            });
        ...
        // 🔹 Caso polígono
        else if (args!.fenceModel!.type == "polygon" && args!.fenceModel!.coordinates != null) {
          Iterable list = args!.fenceModel!.coordinates ?? [];
...
Color hexToColor(String hexColor, {double opacity = 1.0}) {
  ...
  if (hexColor.length == 6) {
    hexColor = 'FF$hexColor'; // Añadir FF para opacidad 100%
  }
